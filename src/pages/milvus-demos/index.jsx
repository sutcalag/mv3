      ...
      <Layout darkMode={true} locale={locale}>
        <section className={styles.banner}>
          <div className={styles.bannerContent}>
            <h2>Milvus makes it easy to add similarity {!isMobile && <br />} search to your applications.</h2>
            <p>Store, index, and manage massive embedding vectors generated by {!isMobile && <br />} deep neural networks and other machine learning (ML) models.</p>
          </div>
          ...
          <div className={styles.milvusCommunity}>
            ...
            <div className={styles.leftPart}>
              ...
              <div className={styles.join}>
                ...
                <p>We appreciate and encourage you to join the Milvus {!isMobile && <br />} community and make contributions altogether.</p>
              </div>
            </div>
        ...
        <section className={styles.subscribe}>
          <div className={styles.inner}>
            <div className={styles.section}>
              ...
              <p>Monthly hand-picked discoveries and stories of thriving{!isMobile && <br />}technologies in a new world of data.</p>
            </div>
            <div className={`${styles.section} ${styles.inputWrapper}`}>
              <input className={styles.input} type="text" placeholder="What’s your email?"
                ref={inputRef}
              />
              <button className={styles.button} onClick={handleSubmitEmail}>Subscribe</button>
            </div>
          </div>
